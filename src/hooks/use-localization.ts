...
const translations = {
  en: {
    ...
    aiNewsSummarizer: 'AI News Summarizer',
    summarizerDesc: 'Paste a news article below to get a quick, easy-to-understand summary.',
    summarize: 'Summarize',
    summarizing: 'Summarizing...',
    summariesDisclaimer: 'Summaries are AI-generated and may contain inaccuracies.',
    summary: 'Summary:',
    login: 'Login',
    english: 'English',
    marathi: 'मराठी',
  ...
  mr: {
    ...
    aiNewsSummarizer: 'एआय बातमी सारांशक',
    summarizerDesc: 'एक जलद, समजण्यास सोपा सारांश मिळविण्यासाठी खाली एक बातमी लेख पेस्ट करा.',
    summarize: 'सारांश करा',
    summarizing: 'सारांश होत आहे...',
    summariesDisclaimer: 'सारांश एआय-व्युत्पन्न आहेत आणि त्यात चुका असू शकतात.',
    summary: 'सारांश:',
    login: 'लॉगिन',
    english: 'English',
    marathi: 'मराठी',
